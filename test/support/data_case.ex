defmodule DeadSimpleCms.DataCase do
  @moduledoc """
  ...
  by setting `use DeadSimpleCms.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(DeadSimpleCms.Repo, shared: not tags[:async])
