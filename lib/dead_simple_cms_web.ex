defmodule DeadSimpleCmsWeb do
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import DeadSimpleCmsWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias DeadSimpleCmsWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: DeadSimpleCmsWeb.Router,
        statics: DeadSimpleCmsWeb.static_paths()
    end
  end
